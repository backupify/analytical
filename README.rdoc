...
Build test container with:

'docker build --no-cache -t analytical .'

Enter container:

'docker run -it --rm -v $(pwd):/app analytical'

Run tests

'bundle exec rake spec'

Run example rails app:
'cd example'
'cd rails4.2'
'bundle install'
'bundle exec rake test:all'

{<img src="https://secure.travis-ci.org/backupify/analytical.png" />}[http://travis-ci.org/backupify/analytical]
