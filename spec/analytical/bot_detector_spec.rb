...
describe "Analytical::BotDetector" do
  ...
  describe 'with nil user_agent' do
    it 'should return false' do
      @d.analytical_is_robot?(nil).should be false
    end
  end

  describe 'with empty user_agent' do
    it 'should return false' do
      @d.analytical_is_robot?('').should be false
    end
  end
  
  describe 'with whitelist user_agent' do
    it 'should return false' do
      @d.analytical_is_robot?('whitelist', ['whitelist']).should be false
    end
  end

  describe 'with whitelist user_agent' do
    it 'should return true' do
      @d.analytical_is_robot?('whitelist').should be true
    end
  end
end
